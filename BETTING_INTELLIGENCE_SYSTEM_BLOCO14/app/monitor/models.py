...
class MonitorRunModel(Base):
    ...
    value_opportunities_count = Column(Integer, default=0)
...
class CollectorHealthModel(Base):
    ...
    unique_events = Column(Integer, default=0)
    duplicate_rate_percent = Column(Float, default=0.0)
    missing_start_percent = Column(Float, default=0.0)
    supported_market_percent = Column(Float, default=0.0)

...
MARKET_ALIASES = {
    ...
    'resultado final':'MATCH_RESULT', '1x2':'MATCH_RESULT',
    ...
    'handicap':'HANDICAP', 'asian handicap':'HANDICAP', 'handicap asiatico':'HANDICAP',
    ...
    'primeiro gol':'FIRST_GOAL', 'first goal':'FIRST_GOAL',
